...
```sh
git clone git@github.com:muse-coder/SC-DNN-Architecture.git
cd SC-DNN-Architecture
```
...
#### Commit your changes
```sh
git commit -m 'Starting SC-DNN-Architecture'
